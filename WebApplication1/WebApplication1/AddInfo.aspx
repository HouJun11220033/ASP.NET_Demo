    ...
    <div>
        <table width="900" id="tedit" runat="server">
            ...
            <tr>
                ...
                <td colspan="3" class="tdRight">
                    <FCKeditorV2:FCKeditor ID="FCKeditor1" runat="server" BasePath="fckeditor/" Width="500px"
                        Height="300px">
            ...
            <tr>
                <td colspan="4" class="tdCenter">
                    ...
                    <asp:Button ID="Button2" runat="server" Style="margin-left: 88px" Text="返回列表" OnClick="Button2_Click"
                        Width="111px" />
                </td>
            </tr>
        </table>
